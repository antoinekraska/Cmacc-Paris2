...
P.1-18.Sec=<b>{P.Ti}</b><br><br><ul style="padding-left: 0"><li>{P1.Among.QQ.Block}<br></li><li>{P2.Among.QQ.Block}<br></li><li>{P3.Among.QQ.Block}<br></li><li>{P4.Among.QQ.Block}<br></li><li>{P5.Among.QQ.Block}<br></li><li>{P6.Among.QQ.Block}<br></li><li>{P7.Among.QQ.Block}<br></li><li>{P8.Among.QQ.Block}<br></li><li>{P9.Among.QQ.Block}<br></li><li>{P10.Among.QQ.Block}<br></li><li>{P11.Among.QQ.Block}<br></li><li>{P12.Among.QQ.Block}<br></li><li>{P13.Among.QQ.Block}<br></li><li>{P14.Among.QQ.Block}<br></li><li>{P15.Among.QQ.Block}<br></li><li>{P16.Among.QQ.Block}<br></li><li>{P17.Among.QQ.Block}<br></li><li>{P18.Among.QQ.Block}<br></li><li>{P.Def.sec}</li></ul>
...
Sign.1-18.Sec=<table><tr><td valign="top" width="300px"><hr>{P1.Sign.QQ.Block}</td><td width="100px"></td><td valign="top" width="300px"><hr>{P2.Sign.QQ.Block}</td></tr><tr><td valign="top" width="300px"><hr>{P3.Sign.QQ.Block}</td><td></td><td valign="top" width="300px"><hr>{P4.Sign.QQ.Block}</td></tr><tr><td valign="top" width="300px"><hr>{P5.Sign.QQ.Block}</td><td></td><td valign="top" width="300px"><hr>{P6.Sign.QQ.Block}</td></tr><tr><td valign="top" width="300px"><hr>{P7.Sign.QQ.Block}</td><td width="100px"></td><td valign="top" width="300px"><hr>{P8.Sign.QQ.Block}</td></tr><tr><td valign="top" width="300px"><hr>{P9.Sign.QQ.Block}</td><td width="100px"></td><td valign="top" width="300px"><hr>{P10.Sign.QQ.Block}</td></tr><tr><td valign="top" width="300px"><hr>{P11.Sign.QQ.Block}</td><td width="100px"></td><td valign="top" width="300px"><hr>{P12.Sign.QQ.Block}</td></tr><tr><td valign="top" width="300px"><hr>{P13.Sign.QQ.Block}</td><td width="100px"></td><td valign="top" width="300px"><hr>{P14.Sign.QQ.Block}</td></tr><tr><td valign="top" width="300px"><hr>{P15.Sign.QQ.Block}</td><td width="100px"></td><td valign="top" width="300px"><hr>{P16.Sign.QQ.Block}</td></tr><tr><td valign="top" width="300px"><hr>{P17.Sign.QQ.Block}</td><td width="100px"></td><td valign="top" width="300px"><hr>{P18.Sign.QQ.Block}</td></tr></table>
